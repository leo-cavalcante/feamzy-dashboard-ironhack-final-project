...
card_users_key_metrics = dbc.Card([
     dbc.CardBody(
         [
             html.H3('Key Metrics',style={'marginLeft': 4,'color': 'white',}),
...
card_classes_key_metrics = dbc.Card([
     dbc.CardBody(
         [
             html.H3('Key Metrics',style={'marginLeft': 10,'color': '#4e99f6',}),
 ...
 ],inverse=True,outline=False)#,outline=False,color='#4e99f6',)

card_classes_key_metrics_1 = dbc.Card([
     dbc.CardBody(
         [
                dbc.Row([dbc.Col([html.Img(src="https://img.icons8.com/clouds/2x/child-safe-zone.png", alt="Kids icon",style={'maxWidth': '50%', 'maxHeight': '50%','textAlign': 'center',})]),
                         ], align="center"),
             dbc.Row([dbc.Col([html.H4(children=[(classes["nbChild"].sum())], style={'marginTop': 25, 'fontSize': 50, 'color': '#4e99f6','textAlign': 'center'}),
                                html.H6(children=["Children assigned to Classes"], style={'marginBottom': 25, 'color': 'grey', 'textAlign': 'center'})]),
                      dbc.Col([html.H6(children=["and"], style={'marginBottom': 25, 'textAlign': 'center','color': 'grey'})], width=2, align="center"),
                      dbc.Col([html.H4(children=[classes["nbArchivedChildren"].sum()], style={'marginTop': 25, 'fontSize': 50, 'color': '#4e99f6','textAlign': 'center'}),
                               html.H6(children=["Archived Children"], style={'marginBottom': 25, 'color': 'grey', 'textAlign': 'center'})]),
     ...
     dbc.CardBody(
         [
             dbc.Row([dbc.Col([html.Img(
                 ...
                 alt="School icon", style={'maxWidth': '50%', 'maxHeight': '50%', 'textAlign': 'center', 'marginLeft': 20, })]),
                      ], align="center"),
             dbc.Row([dbc.Col([html.H4(id='unique-schools', style={'marginTop': 25, 'fontSize': 50, 'color': '#4e99f6','textAlign': 'center'}),
                               html.H6(children=["Unique Schools"],style={'marginBottom': 25, 'textAlign': 'center', 'color': 'grey'})], align="end"
                              ),
                      dbc.Col([html.H6(children=["of which"],style={'marginBottom': 25, 'textAlign': 'center', 'color': 'grey'})], width=2,align="center"),
                      dbc.Col([html.H4(id='schools-without-children', children=[],style={'marginTop': 25, 'fontSize': 50, 'color': '#4e99f6','textAlign': 'center'}),
...
card_classes_key_metrics_3 = dbc.Card([
     dbc.CardBody(
         [
             dbc.Row([dbc.Col([html.Img(src="https://img.icons8.com/bubbles/2x/classroom.png", alt="Classroom icon",
                                        style={'maxWidth': '40%', 'maxHeight': '40%', 'textAlign': 'center','height': 200,'width': 200})]),
                        ], align="center"),
            dbc.Row([dbc.Col([html.H4(id='unique-classes', style={'marginTop': 25, 'fontSize': 50, 'color': '#4e99f6','textAlign': 'center'}),
                               html.H6(children=["Unique Classes"],style={'marginBottom': 25, 'textAlign': 'center', 'color': 'grey'})], align="end"
                              ),
                      dbc.Col([html.H6(children=["of which"],style={'marginBottom': 25, 'textAlign': 'center', 'color': 'grey'})], width=2,align="center"),
                      dbc.Col([html.H4(id='classes-without-children', children=[],style={'marginTop': 25, 'fontSize': 50, 'color': '#4e99f6','textAlign': 'center'}),
...
card_classes_pie_chart = dbc.Card([dbc.CardBody([dcc.Graph(id='public-prive')])],inverse=True,)#color='#4e99f6',outline=False,#color='primary',)
...
card_homeworks_visualisations_1 = dbc.Card([dbc.CardBody([dcc.Graph(id="homeworks-type")])],color='#F8F4F4',)
...
app.layout = html.Div(children=[
    ...
    html.Br(),
    html.Div([
        html.H2('CLASSES',style={'marginLeft': 10,'color': '#4e99f6', 'textShadow': '2px 2px black'}),
        html.Br(),
        html.H3('Key Metrics',style={'marginLeft': 10,'color': '#4e99f6',}),
        dbc.CardGroup([card_classes_key_metrics_1, card_classes_key_metrics_2, card_classes_key_metrics_3]),
        html.Br(),
        dbc.Row([dbc.Col(card_classes_map, width=8),
                 dbc.Col(card_classes_pie_chart,width=4)],align='center'),
        #dcc.Dropdown(id='regions_picker', options=region_options, value=sorted(list(classes.libelle_region.unique())), multi=True, style={'marginLeft': 10,'marginRight': 10}),
        #dcc.Graph(id="classes_map")
    ...
    ],   style={'marginLeft': 10, 'marginRight': 10,'backgroundColor':'#F8F4F4'}),
    html.Br(),
    html.Br(),
    html.Div([html.H2('DOCUMENTS', style={'marginLeft': 10, 'marginRight': 10,'color': '#4e99f6', 'textShadow': '2px 2px black'}),
    dbc.Row(
    ...
    html.Br(),
    html.H2('EVENTS', style={'marginLeft': 10,'color': '##4e99f6', 'textShadow': '2px 2px black'}),
    html.Br(),
    ...
    html.Br(),
    html.Br(),
    html.Div(dbc.Col([dcc.Graph(id='events-dayofweek')],align="center")),
...
def doc_type(selected_regions):
    ...
    fig = px.bar(df, x=df.Number, y=df.Type, color_discrete_sequence=["#2dd36f","#4e99f6","#7039bd","#f8e71c"])
    ...
    fig.update_layout(
        ...
        width=400, height=200,xaxis={'showgrid': False},yaxis={'showgrid': False}
        )
